  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-hero">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-10 right-10 w-14 h-14 bg-primary rounded-lg animate-float lego-brick" style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <div className="section-container relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8">
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-16 lg:justify-center lg:ml-12">
              <Button 
